...
export const LandingPage: React.FC = () => {
  ...
  const statsList = [
    ...
    { val: portalData?.trainerCount || '3', label: 'Pelatih Elit' },
    ...
    <div className="min-h-screen bg-bg-deep text-text-main font-inter selection:bg-accent/30 selection:text-white overflow-x-hidden bg-mesh scroll-smooth">
      ...
      <section id="trainers" className="py-40 px-8 bg-black/20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {[
              { name: 'Marcus Reid', role: 'Kepala Kekuatan', tags: ['Hipertrofi', 'Biomekanika'] },
              { name: 'Sofia Reyes', role: 'Spesialis HIIT', tags: ['V02 Max', 'Penurunan Lemak'] },
              { name: 'Jake Torres', role: 'Bio-hacker Nutrisi', tags: ['Keto', 'Rekomposisi'] },
            ].map((t, i) => (
